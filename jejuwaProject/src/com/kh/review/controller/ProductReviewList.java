...
/**
 * Servlet implementation class ProductReviewList
 */
@WebServlet("/product.rvs")
public class ProductReviewList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 *     
		 *     startPage == n * 10 + 1 == (currentPage - 1) / pageLimit * pageLimit + 1
		 */
