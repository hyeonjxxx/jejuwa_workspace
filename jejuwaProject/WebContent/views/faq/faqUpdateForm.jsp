        	...
        	<input type = "hidden" name = "fno" value = "<%=f.getFaqNo() %>">
	            <table align="center" class="table table-bordered" id="detailArea">
	                ...
	                <tr>
	                    <th>제목</th>
	                    <td>
	                    	<input type="text" name="title" value="<%= f.getFaqTitle() %>" style="width: 100%;" required>
	                    </td>
	                </tr>
	                <tr>
	                    <th>내용</th>
	                    <td>
	                    	<textarea name="content" rows="10" style="resize:none; width: 100%;" required><%= f.getFaqContent() %></textarea>
	                    </td>
	                </tr>
	            </table>
           		<br><br>
