		        ...
		        <div class="pdt_wrap">
			        ...
			        <div class="bottomArea">
			            ...
			            <div align="center" id="pagingArea"  class="pagination justify-content-center">
		                    ...
		                    <%} else {%>
			                    <button onclick="location.href='<%=contextPath%>/fdView.pdt?currentPage=1';">&laquo;</button>
			                    <button onclick="location.href='<%=contextPath%>/fdView.pdt?currentPage=<%=currentPage-1%>';">&lt;</button>			
							<% } %>
							...
							<% for(int p=startPage; p<endPage; p++ ) {%>
		                        ...
		                        <% }else{ %>				
			                        <button onclick="location.href='<%=contextPath%>/fdView.pdt?currentPage=<%= p %>';"><%= p %></button>
		                        <% } %>		
		                	<% } %>
		                	...
		                	<% } else{ %>
		                		<button onclick="location.href='<%=contextPath%>/fdView.pdt?currentPage=<%=currentPage+1%>';">&gt;</button>
			                    <button onclick="location.href='<%=contextPath%>/fdView.pdt?currentPage=<%=maxPage%>';">&raquo;</button>
		                	<% } %>
		             	</div>
		    		</div>					
